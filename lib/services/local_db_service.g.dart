...
class $LocalProcessingConditionsTable extends LocalProcessingConditions
  ...
  static const VerificationMeta _wireTypeMeta = const VerificationMeta(
    'wireType',
  );
  @override
  ...
  static const VerificationMeta _wireSizeMeta = const VerificationMeta(
    'wireSize',
  );
  @override
  ...
  static const VerificationMeta _termPartNoMeta = const VerificationMeta(
    'termPartNo',
  );
  @override
  ...
  static const VerificationMeta _addPartsMeta = const VerificationMeta(
    'addParts',
  );
  @override
  ...
  static const VerificationMeta _topDialMeta = const VerificationMeta(
    'topDial',
  );
  @override
  ...
  static const VerificationMeta _bottomDialMeta = const VerificationMeta(
    'bottomDial',
  );
  @override
  ...
  static const VerificationMeta _hindDialMeta = const VerificationMeta(
    'hindDial',
  );
  @override
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('bottom_dial')) {
      context.handle(
        _bottomDialMeta,
        bottomDial.isAcceptableOrUnknown(data['bottom_dial']!, _bottomDialMeta),
      );
    }
  ...
  LocalProcessingCondition map(
    ...
    return LocalProcessingCondition(
      ...
      wireType: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}wire_type'],
      )!,
      wireSize: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}wire_size'],
      )!,
      termPartNo: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}term_part_no'],
      )!,
      addParts: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}add_parts'],
      )!,
      topDial: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}top_dial'],
      ),
      bottomDial: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}bottom_dial'],
      ),
      hindDial: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}hind_dial'],
      ),
    );
  }
...
class LocalProcessingCondition extends DataClass
  ...
  factory LocalProcessingCondition.fromJson(
  ...
  LocalProcessingCondition copyWithCompanion(
    ...
    return LocalProcessingCondition(
      ...
      termPartNo: data.termPartNo.present
          ? data.termPartNo.value
          : this.termPartNo,
      ...
      bottomDial: data.bottomDial.present
          ? data.bottomDial.value
          : this.bottomDial,
...
class $$LocalProcessingConditionsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
  ...
  $$LocalProcessingConditionsTableTableManager(
    _$AppDatabase db,
    $LocalProcessingConditionsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
